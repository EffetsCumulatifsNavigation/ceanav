...
tab %>%
  knitr::kable(
    ...
    row.names = FALSE,
    caption = "Liste des sous-catégories de composantes valorisées considérées pour l'évaluation des effets cumulatifs des activités maritimes dans le Saint-Laurent et le Saguenay."
  ) %>%
