### Pêche commerciale {#pecheportrait}
...
où $j$ est une cellule de la grille d'étude, $k$ est une activité de pêche et $P_k$ est la zone tampon entourant chaque activité de pêche $k$. Cette formule calcule l'intensité de pêche en nombre d'activités de pêche répertoriées. Puisque nous avons calculé l'intensité au sein de cellules de 1 $km^2$, les unités de cette formule sont en nombre d'activités ($n$) par $km^2$, soit $n * km^{-2}$. Puisque des zones tampons ont été utilisées autour de chaque activité, il est posible qu'une seule activité de pêche soit répertoriée pour plus d'une cellule de la grille d'étude. La somme totale des activités dans la grille d'étude ne sera ainsi pas égale à la somme totale réelle des activités de pêche répertoriées dans la zone d'étude. 
