...
```{r PASSENGER, fig.cap = "Intensité de la navigation dans le Saint-Laurent et le Saguenay - Passager", out.width = '100%', fig.link = "./figures/figures-integrated/navigation-PASSENGER.png"}
...
```{r FERRYRORO, fig.cap = "Intensité de la navigation dans le Saint-Laurent et le Saguenay - Traversier / roulier", out.width = '100%', fig.link = "./figures/figures-integrated/navigation-FERRY.RO.RO.png"}
