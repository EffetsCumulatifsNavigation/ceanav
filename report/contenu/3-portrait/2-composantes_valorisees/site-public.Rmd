...
Les milieux protégés ont été caractérisé par l'intégration de trois bases de données. La première base de données correspond à la délimitation des différentes mesures de gestion spatiales mises en place dans le parc marin du Saguenay–Saint-Laurent [@apc2021]. Cette base de données regroupe la délimitation de mesures spatiales règlementaires (*e.g.* zones d'interdiction de navigation et zones de ralentissement) ainsi que des mesures spatiales volontaires (*e.g.* zones de ralentissement et zones à éviter). La deuxième base de données provient du Gouvernement du Canada et délimite des milieux où des mesures de gestion reconnues comme *autres mesures efficaces de conservation par zone* [EMCEZ; @mpo2021d]. Au sein de notre zone d'étude, cette base de donnée présente une seule zone protégée [en amont de la Rivière Saguenay](https://www.dfo-mpo.gc.ca/oceans/oecm-amcepz/refuges/saguenay-fra.html) qui limite les activités de pêche pour protéger l'habitat du béluga et pour éviter la remise en suspension de sédiments contaminés.
