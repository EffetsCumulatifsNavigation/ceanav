...
Ces milieux ont été cartographiés à l'aide d'approche cartographiques à haute résolution combinant des données de relevés terrain, de télédétection et dérivées de connaissances des communautés locales [@bernier2020; @bernier2021].
...
Les données utilisées pour caractériser les gisements coquilliers dans la zone d'étude proviennent d'une description des stocks de mactre de Stimpton (*Mactromeris polynyma*) en milieux côtiers au Québec [@trottier2015; @mpo2019]. Les données fournissent la délimitation de gisements connus et commercialement exploités hitoriquement ou actuellement pour toute la région québécoise de l'estuaire et du golfe du Saint-Laurent. 
