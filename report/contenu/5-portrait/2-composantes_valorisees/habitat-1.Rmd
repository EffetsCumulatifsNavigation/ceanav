...
tab <- select(tab, type, francais, superficie, source)
...
tab %>%
  knitr::kable(
    col.names = c("Catégories d'habitats", "Sous-catégories", "Superficie $km^2$", "Données utilisées$^*$"),
    row.names = FALSE,
    caption = "Catégories d'habitats considérés pour l'analyse des effets cumulatifs de la navigation dans le Saint-Laurent et le Saguenay et leur superficie totale dans la zone d'étude. $^*$Consultez les annexes 3 et 4 pour plus de détails sur les données utilisées."
  )
```
