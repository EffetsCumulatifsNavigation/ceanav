...
tab <- select(tab, francais, english, observations, boats, transit)


tab %>%
  knitr::kable(
    col.names = c("Types de navire", "Vessel types", "Localisations", "Navires","Transits$^*$"),
    row.names = FALSE,
    caption = "Types de navires considérés pour l'analyse d'évaluation des effets cumulatifs et disponible par les données de Système d'Identification Automatique [@transportscanada2020a; @transportscanada2020b]. $^*$Nombre de transits par $km^2$ par année."
  )
```
