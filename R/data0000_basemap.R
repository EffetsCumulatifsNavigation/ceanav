...
get_basemap <- function() {
  ...
  cities <- rbind(c("Montréal", 45.50254228022055, -73.60212361152767),
                  c("Sorel-Tracy", 46.04602094647503-.05, -73.11066440843165),
                  c("Trois-Rivière", 46.369134392835505+.01, -72.57437227244509-.01),
                  c("Portneuf", 46.69773995828071+.02, -71.89258221436206-.02),
                  c("Québec", 46.81389793427603+.02, -71.21222137489029-.05),
                  c("La Pocatière", 47.36885583905954, -70.02321997363107+.04),
                  c("Baie-Saint-Paul", 47.440943292425075+.03, -70.51229725440152-.04),
                  c("Tadoussac", 48.1549463212358+.04, -69.7254261992016+.02),
                  c("Rivière-du-Loup", 47.84514499357216-.01, -69.5537057317311+.07),
                  c("Rimouski", 48.44414698303665-.03, -68.54511969494227+.05),
                  c("Forestville", 48.7417453695865+.02, -69.08201781318876-.05),
                  c("Baie-Comeau", 49.222495074896855+.02, -68.1603788485369-.04),
                  c("Matane", 48.847708031386716-.04, -67.52783889874046+.03),
                  c("Saint-Fulgence", 48.452471677247125+.04, -70.90072260561196),
                  c("La Baie", 48.34102261306717-.03, -70.88195643377449-.05)) %>%
            data.frame() %>%
