...
get_data0008 <- function() {
  ...
  # ----------------------------------------
  # Output folder
  output <- "data0008-milieu_sableux/"
  ...
  if (!file.exists(paste0(folder, 'atlas_estuairegolfe_rapport_final_fr.pdf'))) {
    ...
    download.file(milieu_cotier[2], destfile = paste0(folder, 'milieuxsableux_publ_janv2019.zip'))
