...
```{r cv}
tab <- select(cv, title, type, title_en, type_en, simple,source) %>%
...
tab %>%
  knitr::kable(
    ...
    row.names = FALSE,
    caption = "List of valued component subcategories considered for the cumulative effects assessment of marine activities in the St. Lawrence and the Saguenay river. See [Appendix 1](#annexe1) for more details on data sources."
  ) #%>%
